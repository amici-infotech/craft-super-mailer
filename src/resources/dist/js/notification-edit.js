(function() {
    ...
    /**
     * Determines whether the selected event belongs directly to the Craft Entry element type.
     */
    ...
    /**
     * Filters condition field options so entry-only conditions are only shown for Entry events.
     */
